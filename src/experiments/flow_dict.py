...
all_flows = [
    {"id": "f1", "type": "data", "port": 22, "client": "dot123", "server": "dot08", "rate":80,
     "data_loc": "/home/pi/", "user": "pi", "priority":6
     ,"path": ["dot123", "ps4", "ps2", "dot08"]
     },

    {"id": "f2", "type": "data", "port": 22, "client": "dot08", "server": "dot123", "rate": 80,
     "data_loc": "/home/pi/", "user": "pi", "priority": 6
        , "path": ["dot08", "ps2", "ps4", "dot123"]
     },

    # {"id": "f1", "type": "data", "port": 22, "client": "dot123", "server": "dot08", "rate": 80,
    #  "data_loc": "/home/pi/", "user": "pi", "priority": 6
    #     , "path": ["dot123", "ps4", "ps2", "dot09"]
    #  },
    #
    # {"id": "f1", "type": "data", "port": 22, "client": "dot123", "server": "dot08", "rate": 80,
    #  "data_loc": "/home/pi/", "user": "pi", "priority": 6
