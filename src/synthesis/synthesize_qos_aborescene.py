...
class SynthesizeQoSAborescene():
    ...
    def compute_intents(self, dst_h_obj, flow_match, rate):
    ...
    def synthesize_all_dsts(self, rate):
        ...
        for dst in self.network_graph.host_ids:
            ...
            self.compute_intents(dst_h_obj, flow_match, rate)
            print "-----------------------------------------------------------------------------------------------"
